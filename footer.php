                     ...
                     <div class="row align-items-end">
                        <div class="col-12">
                           <div class="tp-footer-top-social-wrap text-center mb-30">
                              <span class="tp-footer-top-subtitle tp-text-theme-primary fw-500 fs-18 tp-ff-heading mb-5 d-inline-block tp_fade_anim" data-delay=".3">Un projet en tête ?</span>
                              <h2 class="tp-footer-top-title rotate-text-anim tp-text-common-white lh-1 text-uppercase fw-500 mb-45">Travaillons<br> ensemble.</h2>
                              <div class="tp-footer-social tp-footer-pp-social tp_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
                                 <ul>
                                    ...
                                    <li>
                                       <a href="https://www.linkedin.com/in/colin-no%C3%ABl/" target="_blank">
                        ...
                        <div class="col-lg-6">
                           <div class="tp-footer-pp-widget ml-25 mb-40 tp_fade_anim" data-delay=".7">
                              <span class="tp-ff-heading fw-500 fs-18 tp-text-common-white mb-35 d-inline-block">
                                 ...
                                 Basé dans la Manche, France
                              </span>
                              <div class="tp-footer-pp-link">
                                 <a class="mr-35" href="mailto:noel_colin@icloud.com">noel_colin@icloud.com</a>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-12">
                           <div class="tp-footer-copyright text-center">
                              <p class="mb-0 tp-text-grey-2">
                                 ...
                                 Copyright 2026 <a class="tp-text-common-white hover-text-primary" href="#">Colin Noël</a> Tous droits réservés.
                              </p>
                           </div>
                        </div>
                     </div>
